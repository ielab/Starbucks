...
def main():
    parser = HfArgumentParser((SrlDenseModelArguments, DataArguments, TrainingArguments))
    ...
    if model_args.srl_training:
        print("Using Starbucks Representation Learning")
        model = SrlDenseModel.build(
            model_args,
            training_args,
            cache_dir=model_args.cache_dir,
        )
